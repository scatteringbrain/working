...
//runManager -> SetUserInitialization(physicsList);
    ...
    // so new something was the problem : file name or class 
  //  runManager -> SetUserInitialization(new ActionInitialization); //this is the name of the header // or the class with filename?
