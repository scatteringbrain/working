...
G4double world_rmin = 0.12*rmin , world_rmax = 1.2*rmax , world_sphi = 0*deg, world_dphi = 360*deg, world_sthe = 0*deg, world_dthe = 180*deg ;
G4Material* world_mat = nist -> FindOrBuildMaterial("G4_AIR");


auto solidWorld = new G4Sphere("World", // its name
0, world_rmax, world_sphi, world_dphi, world_sthe, world_dthe);
